...
'''
:class: 'Cono'. Clase para calcular las coordenadas cartesianas de un Cono a lo largo del eje 'eje' con centro de la base en 'base', de radio máximo 'radio_max' y largo 'largo'.
'''
...
class Cono:
    ...
    def calcula_coordenadas(self):
        ...
        # Armo dos vectores unitarios perpendiculares entre sí y al eje del cono, para que hagan las veces de ejes 'x' e 'y' sobre el que construir el cono. Primero busco un vector en una dirección distinta al eje. Luego, con éste y el eje, armo un vector unitario n1 perpendicular al eje. Finalmente, con eje y n1 armo un vector unitario n2 perpendicular a ambos.
