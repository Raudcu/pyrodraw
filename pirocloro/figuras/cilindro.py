...
'''
:class: 'Cilindro'. Clase para calcular las coordenadas cartesianas de un Cilindro a lo largo del eje 'eje' centrado en 'pivot', de radio 'radio' y largo 'largo'.
'''
...
class Cilindro:
    ...
    def __init__(self, pivot, eje, radio, largo):
        ...
        self.base = self.pivot - self.largo/2 * self.eje # Coordenadas del centro de la base del cilindro
        self.tapa = self.pivot + self.largo/2 * self.eje # Coordenadas del centro de la tapa del cilindro
    ...
    def calcula_coordenadas(self):
        ...
        # Armo dos vectores unitarios perpendiculares entre sí y al eje del cilindro, para que hagan las veces de ejes 'x' e 'y' sobre el que construir el cilindro. Primero busco un vector en una dirección distinta al eje. Luego, con éste y el eje, armo un vector unitario n1 perpendicular al eje. Finalmente, con eje y n1 armo un vector unitario n2 perpendicular a ambos.
